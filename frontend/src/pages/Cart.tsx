...
import { ShoppingBag, Trash2, Shield, Banknote, Smartphone, Truck, Lock, ShieldCheck } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-100 sticky top-24">
            ...
            <div className="mb-6">
              <h4 className="font-bold text-gray-900 text-sm uppercase tracking-wider mb-3">Payment Method</h4>
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <Smartphone className={`w-6 h-6 mx-auto mb-2 ${paymentMethod === 'mpesa' ? 'text-[#1a5c38]' : 'text-gray-400'}`} />
                  <p className={`text-sm font-bold ${paymentMethod === 'mpesa' ? 'text-[#1a5c38]' : 'text-gray-500'}`}>M-Pesa</p>
                  <p className="text-[10px] text-gray-400 mt-0.5">Pay now via STK</p>
                </button>
                <button
                ...
                >
                  <Banknote className={`w-6 h-6 mx-auto mb-2 ${paymentMethod === 'cash' ? 'text-[#e8a020]' : 'text-gray-400'}`} />
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder={paymentMethod === 'mpesa' ? 'M-Pesa number (07... or +254...)' : 'Phone number (07... or +254...)'}
                    className="w-full p-4 rounded-xl bg-gray-50 border-none focus:ring-2 focus:ring-[#1a5c38] outline-none transition-all text-sm font-medium"
                  />
                </div>
              </div>
